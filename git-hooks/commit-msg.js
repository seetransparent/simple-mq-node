...
if (/^(HOTFIX|[A-Z]{1,6}-[0-9]{1,6})/.test(commitMessage)) {
  process.exit(0);
} else {
  console.log(`Invalid commit message <${commitMessage.trim()}>. Please remember to add the issue number or HOTFIX if none`);
  process.exit(1);
}
